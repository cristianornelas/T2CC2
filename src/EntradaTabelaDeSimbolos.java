...
public class EntradaTabelaDeSimbolos {
    ...
    public void printETDS() {
        ...
        switch(this.tipoEntrada){
            case 0:
                System.out.println("Tipo Entrada: " + this.tipoEntrada);
                System.out.println("Nome: " + this.nome);
                System.out.println("Tipo Grafo: " + this.tipoGrafo);
            ...
            case 2:
                System.out.println("Tipo Entrada: " + this.tipoEntrada);
                System.out.println("Nome: "+ this.nome);
                System.out.println("Vertice 1: " + this.vertice1);
                System.out.println("Vertice 2: " + this.vertice2);
                System.out.println("Linha: " + this.linha);
                System.out.println("Parents: " + this.parents);
                break;
            case 3:
                System.out.println("Tipo Entrada: " + this.tipoEntrada);
                System.out.println("Nome: "+ this.nome);
                System.out.println("Atributos: " + this.atributos);
                System.out.println("Linha: " + this.linha);
                System.out.println("Parents: " + this.parents);
                break;
            case 4:
            ...
            case 5:
                ...
                System.out.println("ValueF: " + this.valueF);
                System.out.println("ValueS: " + this.valueS);
                System.out.println("EFloat: " + this.eFloat);
                System.out.println("Parents: " + this.parents);
                break;
        } 
    }
